        ...
        <div className="max-w-4xl space-y-8">
            <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <SettingSection icon={Globe} title="General" description="Platform name, domain settings, and SEO configuration." />
...
const SettingSection = ({ icon: Icon, title, description }) => (
    <GlassCard className="p-6 cursor-pointer hover:bg-white/10 transition-colors group">
